...
void SageCore::calcLikelihoods(std::vector<float>& tmp_likelihoods, size_t question_id, float response) {
...
void SageCore::calcPosteriors(std::vector<float>& tmp_likelihoods, std::vector<float>& tmp_posteriors) {
...
float SageCore::calcEntropy(std::vector<float>& tmp_likelihoods, std::vector<float>& tmp_posteriors, size_t question_id, float response) {
